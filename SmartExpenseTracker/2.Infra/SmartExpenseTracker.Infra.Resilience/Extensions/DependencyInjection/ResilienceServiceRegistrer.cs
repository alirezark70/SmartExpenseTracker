...
namespace SmartExpenseTracker.Extensions.DependencyInjection
{
    public static class ResilienceServiceRegistrer
    {
        public static IServiceCollection RegisterResilienceService(this IServiceCollection services, IConfiguration configuration)
        {
            // Register Options
